// ==UserScript==
// @name        Openplace-infinite-bookmarks
// @name:ja         Openplace Unlimited Favorites⭐ - 無制限保存 & エクスポート機能
// @namespace   https://greasyfork.org/users/1508363
// @version     1.0.1
// @description Openplace Unlimited Favorites⭐ - Unlimited favorites storage on [Openplace.live], with backup & restore functionality, full Blue Marble support, integrated UI type
// @description:ja  Openplace.liveで無制限のお気に入り保存、バックアップ・復元機能付き、Blue Marble完全対応、UI統合型
// @author      Defaulter,gissehel
// @homepage    https://github.com/gissehel/userscripts
// @supportURL  https://github.com/gissehel/userscripts/issues
// @match       https://Openplace.live/*
// @icon        https://www.google.com/s2/favicons?sz=64&domain=Openplace.live
// @grant       GM_setValue
// @grant       GM_getValue
// @grant       GM.setValue
// @grant       GM.getValue
...
// @main_begin{Openplace-infinite-bookmarks}
...
class OpenplaceExtendedFavorites {
    constructor() {
        this.STORAGE_KEY = 'Openplace_extended_favorites';
        this.init();
    }
    ...
    observeAndInit() {
        ...
        const buttonConfigs = [
            ...
            {
                id: 'save-btn',
                selector: '[data-Openplace-save="true"]',
    ...
    createSaveButton(container) {
        ...
        button.setAttribute('data-Openplace-save', 'true');
        button.innerHTML = `
    ...
    async exportFavorites() {
        try {
            ...
            link.download = `Openplace-favorites-${new Date().toISOString().split('T')[0]}.json`;
            link.click();
...
// Initialize
new OpenplaceExtendedFavorites();
// @main_end{Openplace-infinite-bookmarks}
