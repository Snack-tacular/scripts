...
(() => {
  ...
  // CHANGED: Button text to '+' and mainCollapsible class to 'collapsed'
  ...
  <div class="chunk-downloader">
    ...
    <div class="mainCollapsible collapsed">
...
`;
  ...
  // CHANGED: Default state is collapsed (true)
  mainCollapseBtn.dataset.collapsed = "true";
  ...
  `;
    box.innerHTML = `
    <p style="color:#000;">Are you sure you want to delete this preset?</p>
    <label style="display:flex;align-items:center;justify-content:center;margin:8px 0;gap:6px;color:#000;">
